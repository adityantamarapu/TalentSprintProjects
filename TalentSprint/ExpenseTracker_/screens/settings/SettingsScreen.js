...
import ClearDataScreen from "./ClearDataSettingsScreen";
...
function SettingsScreen({ navigation }) {
  return (
    <Stack.Navigator initialRouteName="Settings">
      ...
      />
      <Stack.Screen
        name="ClearDataSettings"
        component={ClearDataScreen}
      />
      <Stack.Screen
...
function SettingsContent({ navigation }) {
  ...
  const handleClearDataPress = () => {
    navigation.navigate("ClearDataSettings");
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity style={styles.settingItem} onPress={handleCategoriesPress}>
